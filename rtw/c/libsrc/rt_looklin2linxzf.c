/* 
 * File: rt_looklin2linxzf.c generated from file
...
real32_T rt_LookLin2LinXZf(const real32_T         u0,
			   const real32_T         u1,
			   ...
			   const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookLinXf(u0, &bpLambda[0], bpData01, maxIndex[0], maxIndex[0] >> 1);
  bpIndex[1] = rt_PLookLinXf(u1, &bpLambda[1], bpData02, maxIndex[1], maxIndex[1] >> 1);
  {
