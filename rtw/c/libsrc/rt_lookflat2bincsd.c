/* 
 * File: rt_lookflat2bincsd.c generated from file
...
real_T rt_LookFlat2BinCSd(const real_T         u0,
			  const real_T         u1,
			  ...
			  const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookBinCd(u0, &bpLambda[0], bpData01, maxIndex[0], bpIndex[0]);
  bpIndex[1] = rt_PLookBinCd(u1, &bpLambda[1], bpData02, maxIndex[1], bpIndex[1]);
  return(rt_Intrp2Flatd(bpIndex, (maxIndex[0]+1), bpLambda, tableData));
}
/* [EOF] rt_lookflat2bincsd.c */
