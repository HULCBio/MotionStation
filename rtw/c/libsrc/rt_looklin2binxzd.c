/* 
 * File: rt_looklin2binxzd.c generated from file
...
real_T rt_LookLin2BinXZd(const real_T         u0,
                         const real_T         u1,
                         ...
                         const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookBinXd(u0, &bpLambda[0], bpData01, maxIndex[0], maxIndex[0] >> 1);
  bpIndex[1] = rt_PLookBinXd(u1, &bpLambda[1], bpData02, maxIndex[1], maxIndex[1] >> 1);
  {
