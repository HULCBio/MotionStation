/* 
 * File: rt_looklin2binxzf.c generated from file
...
real32_T rt_LookLin2BinXZf(const real32_T         u0,
			   const real32_T         u1,
			   ...
			   const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookBinXf(u0, &bpLambda[0], bpData01, maxIndex[0], maxIndex[0] >> 1);
  bpIndex[1] = rt_PLookBinXf(u1, &bpLambda[1], bpData02, maxIndex[1], maxIndex[1] >> 1);
  {
