...
rem
rem    Created automatically from bcc55compp.bat
rem
rem ********************************************************************
rem General parameters
rem ********************************************************************
set MATLAB=%MATLAB%
set BORLAND=%BORLAND%\bcc55
...
rem IDL Compiler
rem ********************************************************************
set IDL_COMPILER=midl /cpp_cmd cpp32 /cpp_opt "-P- -oCON -idl -I%BORLAND%\include" /I %BORLAND%\include\idl /I "%MATLAB%\extern\include"
