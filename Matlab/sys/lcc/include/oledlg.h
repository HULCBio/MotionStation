...
DECLARE_INTERFACE_(IOleUIObjInfoW,	IUnknown) {
	...
	DWORD * lpdwObjSize, LPWSTR * lplpszLabel,
	LPWSTR * lplpszType, LPWSTR * lplpszShortType,
	LPWSTR * lplpszLocation) ;
...
DECLARE_INTERFACE_(IOleUIObjInfoA,	IUnknown) {
	...
	STDMETHOD_(ULONG,Release) (THIS) ;
	STDMETHOD(GetObjectInfo) (THIS_ DWORD dwObject,
	DWORD * lpdwObjSize, LPSTR * lplpszLabel,
	LPSTR * lplpszType, LPSTR * lplpszShortType,
	LPSTR * lplpszLocation) ;
	STDMETHOD(GetConvertInfo) (THIS_ DWORD dwObject,
	CLSID * lpClassID, WORD * lpwFormat,
	CLSID * lpConvertDefaultClassID,
	LPCLSID * lplpClsidExclude, UINT * lpcClsidExclude) ;
...
DECLARE_INTERFACE_(IOleUILinkInfoA,	IOleUILinkContainerA) {
	...
	LPSTR * lplpszFullLinkType, LPSTR * lplpszShortLinkType, BOOL * lpfSourceAvailable, BOOL * lpfIsSelected) ;
	STDMETHOD(OpenLinkSource) (THIS_ DWORD dwLink) ;
	STDMETHOD(UpdateLink) (THIS_ DWORD dwLink, BOOL fErrorMessage, BOOL fReserved) ;
	STDMETHOD(CancelLink) (THIS_ DWORD dwLink) ;
	STDMETHOD(GetLastUpdate) (THIS_ DWORD dwLink, FILETIME * lpLastUpdate) ;
};
...
int	EXPORT CDECL OleUIPromptUserW(int nTemplate, HWND hwndParent, ...);
int	EXPORT CDECL OleUIPromptUserA(int nTemplate, HWND hwndParent, ...);
#ifdef	UNICODE
