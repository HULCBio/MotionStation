...
RpcNsGroupMbrInqBeginW(unsigned long,unsigned short  *,unsigned long,RPC_NS_HANDLE *);
...
#ifdef RPC_UNICODE_SUPPORTED
RPC_STATUS RPC_ENTRY
RpcNsEntryObjectInqBeginW(unsigned long,unsigned short  *,RPC_NS_HANDLE  *);
#endif
...
#endif
RPC_STATUS RPC_ENTRY RpcNsBindingImportNext(RPC_NS_HANDLE ImportContext,RPC_BINDING_HANDLE   * Binding);
