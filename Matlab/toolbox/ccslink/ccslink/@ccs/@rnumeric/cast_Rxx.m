function cast_Rxx(rr,datatype)
% Private. Casting for Rxx register symbols.

% Copyright 2002-2003 The MathWorks, Inc.
%   $Revision: 1.1.4.2 $  $Date: 2003/11/30 23:11:17 $


if (rr.bitsperstorageunit ~=32)
    error('A register unit must contain 32 bits for Rxx register objects');
end
