/* $Revision: 1.4 $ $Date: 2002/03/25 04:02:42 $*/
/* canac2sends.c - xPC Target, non-inlined S-function driver for CAN-AC2-ISA (standard) from Softing (single board)  */
...
#define S_FUNCTION_NAME canac2sends
