/* $Revision: 1.3 $ $Date: 2002/03/25 04:01:51 $ */
/* canac2104setup_mb3.c - xPC Target, non-inlined S-function driver for CAN-AC2-104 from Softing (multi board)  */
...
#define 	S_FUNCTION_NAME 	canac2104setup_mb2
...
static int CANAC2_FIRMWARE_LOADED_mb2;
...
static void printInitErrorText(int iErrorCode)
{
    ...
    switch((unsigned int)iErrorCode)
    {
     ...
     case  INIPC_IB_ERR_VC_RESOURCEACCESSERROR:
         printf("Resource access_mb2 error");
         break;
     case  INIPC_IB_ERR_VC_PHYSMEMORYOVERRUN:
         printf("invalid phys.mem-access_mb2");
         break;
...
static void mdlStart(SimStruct *S)
{
	...
	if (!CANAC2_FIRMWARE_LOADED_mb2) {
		...
		// Load firmware
		printf("        downloading CAN-AC2-104 firmware on B2...\n");
