function [convBaseAddr, SampleTime, SampleOffset] = mdihsad512 (flag, Channels, Sample, BaseAddr)

% MDIHSAD512 - InitFcn and Mask Initialization for HS AD 512 Digital Input Section
...
if (sampleLength > 2)
  error ('Sample length vector can exceed two elements');
end
...
if level1.Used==1
  error('Hardware limits The digital input To one instance');
end
