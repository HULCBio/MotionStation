...
%   $Revision: 1.1.6.2 $  $Date: 2004/04/15 00:20:32 $
...
out.Name = xlate('Signal Property Table');
out.Type = 'SL';
out.Desc = xlate('Inserts a table which reports on signal property-value pairs');
