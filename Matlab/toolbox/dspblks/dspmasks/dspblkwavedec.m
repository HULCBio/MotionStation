function varargout = dspblkwavedec(action,varargin)
%DSPBLKWAVEDEC Signal Processing Blockset Wavelet Analysis block helper function.

% Copyright 1995-2003 The MathWorks, Inc.
% $Revision: 1.6.4.2 $  $Date: 2004/04/12 23:07:39 $
...
frame_based = strcmp(get_param(blk, 'Frame'),'on');
