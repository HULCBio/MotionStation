function mdlref_busscript(varargin)

% Copyright 2003-2004 The MathWorks, Inc.

%MDLREF_BUSSCRIPT Controls the Model Reference  Demo HTML page
%   MDLREF_BUSSCRIPT(action) executes the hyperlink callback 
%   associated with the the strings in varargin
%  
%   The complete set of demo files is as follows.
%      1) mdlref_bus.mdl
%      2) mdlref_counter_bus.mdl 
%      3) mdlref_bus.html 
%      4) mdlref_counter_bus.mat
%      5) mdlref_busscript.m
%
%   Mehmet Yunt 
%     
...
%function   
  ...
  try   
    ...
    mFileName     = 'mdlref_busscript';
    modelName     = 'mdlref_bus';
    refModelName  = 'mdlref_counter_bus';
    htmlName      = 'mdlref_bus.html';  
