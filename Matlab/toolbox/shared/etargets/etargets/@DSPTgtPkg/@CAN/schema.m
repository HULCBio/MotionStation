function schema()
%SCHEMA  Class constructor function (for DSPTgtPkg.CAN).

%   Copyright 2003-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2004/04/08 21:06:25 $
...
%%%% Construct class
hThisClass = schema.class(hCreateInPackage, 'CAN', hDeriveFromClass);
