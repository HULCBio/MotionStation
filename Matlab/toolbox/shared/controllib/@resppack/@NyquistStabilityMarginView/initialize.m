...
%INITIALIZE  Initialization for @NyquistStabilityMarginView class

%  Author(s): John Glass
%  Copyright 1986-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2004/04/11 00:19:14 $
if ~isscalar(Axes)
...
this.MagCrossLines = handle(line(cos(0:0.1/pi:2*pi),sin(0:0.1/pi:2*pi),-10*ones(1,198),...
   'Parent',Axes,...
   'Visible','off',...
   'LineStyle','-.',...
   'Selected','off',...
