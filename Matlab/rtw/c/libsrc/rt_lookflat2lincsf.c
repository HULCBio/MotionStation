/* 
 * File: rt_lookflat2lincsf.c generated from file
...
real32_T rt_LookFlat2LinCSf(const real32_T         u0,
			    const real32_T         u1,
			    ...
			    const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookLinCf(u0, &bpLambda[0], bpData01, maxIndex[0], bpIndex[0]);
  bpIndex[1] = rt_PLookLinCf(u1, &bpLambda[1], bpData02, maxIndex[1], bpIndex[1]);
  return(rt_Intrp2Flatf(bpIndex, (maxIndex[0]+1), bpLambda, tableData));
}
/* [EOF] rt_lookflat2lincsf.c */
