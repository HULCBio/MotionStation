/* 
 * File: rt_looklin2linxsd.c generated from file
...
real_T rt_LookLin2LinXSd(const real_T         u0,
                         const real_T         u1,
                         ...
                         const int_T  * const maxIndex)
{
  ...
  bpIndex[0] = rt_PLookLinXd(u0, &bpLambda[0], bpData01, maxIndex[0], bpIndex[0]);
  bpIndex[1] = rt_PLookLinXd(u1, &bpLambda[1], bpData02, maxIndex[1], bpIndex[1]);
  {
