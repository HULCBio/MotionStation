/* 
 * File: rt_lookflat1evnczf.c generated from file
...
real32_T rt_LookFlat1EvnCZf(const real32_T u,
			    ...
			    const int_T    maxIndex)
{
  ...
  bpIndex = rt_PLookEvnCf(u, &lambda, bpData, maxIndex);
  return(rt_Intrp1Flatf(bpIndex, lambda, tableData));
}
/* [EOF] rt_lookflat1evnczf.c */
