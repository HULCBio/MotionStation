...
<xsl:template name="book.titlepage.recto">
  ...
  <!-- @CHANGE add date and graphic to Book titlepage -->
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/inlinegraphic"/>
  <!-- end @CHANGE -->
...
<!-- @CHANGE allow graphic & date on titlepages -->
