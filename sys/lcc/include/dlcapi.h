...
typedef union {
    ...
    struct { USHORT usStationId;   USHORT usParameter;  } dlc;
    struct { USHORT usParameter0;  USHORT usParameter1; } dir;
    UCHAR auchBuffer[4];            
    ULONG ulParameter;
...
ACSLAN_STATUS APIENTRY AcsLan( PLLC_CCB pCcb, PLLC_CCB* ppBadCcb);
#endif 
