...
% 
%  [odata,it,res] =...
%  DDGgummelmap (imesh,Dsides,idata,toll,maxit,ptoll,pmaxit,verbose)
%
...
for i=1:1:maxit
  ...
  n(:,3) =DDGelectron_driftdiffusion(imesh,Dsides,n(:,2),p(:,2),V(:,2),...
  ...
  p(:,3) =DDGhole_driftdiffusion(imesh,Dsides,n(:,3),p(:,2),V(:,2),...
