...
%   $Revision: 1.1.6.2 $  $Date: 2004/04/15 00:19:43 $
...
out.Name = xlate('Block Property Table');
out.Type = 'SL';
out.Desc = xlate('Inserts a table which reports on block property-value pairs');
