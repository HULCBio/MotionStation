function h = constructPrevCCSVersion(h,args)
...
if nargs <= 1
    ...
    if(mod(nargs,2)~=0)
        error(['PrevCCSVersion constructor requires property and value ', ...
    ...
    for i = 1:2:nargs
        ...
        case 'apiversion'
            h.apiVersion = val;
        otherwise
            error('Unknown property specified for PrevCCSVersion object.')
        end
    end
