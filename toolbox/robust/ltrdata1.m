...
%
% The designed controller is given by [ae,be,ce,de]. During the
...
% A simulation structure with system perturbation is provided in
% LTRDEMO2
%
...
%  pre-calculated data for ltrdemo
