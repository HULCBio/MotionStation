...
% $Revision: 1.1.6.2 $ $Date: 2003/12/04 02:37:12 $
...
set(handles.linearizationsettings, 'ActionPerformedCallback', {@LocalLinearizationSettings,this});
...
for ct = 1:length(toolcomponents)
    switch char(toolcomponents(ct).getToolTipText)
        case 'Task Options'
            ...
            set(handles.settingstoolbar, 'ActionPerformedCallback', {@LocalLinearizationSettings,this}); 
    end
end
