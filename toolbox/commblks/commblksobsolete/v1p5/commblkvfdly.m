function [b,str] = commblkvfdly(varargin)
% COMMBLKVFDLY Mask dynamic dialog function for variable fractional delay block

% Copyright 1996-2002 The MathWorks, Inc.
% $Date: 2003/01/26 18:44:46 $ $Revision: 1.1.6.1 $
