% WCDMA_CHECKPARAMSSPREADANDMOD Checks mask parameters for the
% Wcdmaspreadandmod model included in the Wcdma application examples.

% Copyright 1996-2002 The MathWorks, Inc.
% $Revision: 1.2 $  $Date: 2002/04/11 00:48:58 $
...
if(sum(size(snrdB))>2 | ~isreal(snrdB))
    errordlg('The Signal to Noise Ratio, expressed in dB, must be a real number.');
end
