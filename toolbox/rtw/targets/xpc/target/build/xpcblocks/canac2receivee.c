/* $Revision: 1.4 $ $Date: 2002/03/25 04:04:51 $*/
/* canac2receivee.c - xPC Target, non-inlined S-function driver for CAN-AC2-ISA (extended) from Softing (single board)  */
...
#define S_FUNCTION_NAME canac2receivee
