/* $Revision: 1.5 $ $Date: 2002/03/25 04:02:48 $*/
/* canac2setups.c - xPC Target, non-inlined S-function driver for CAN-AC2-ISA (standard) from Softing (single board)  */
...
#define S_FUNCTION_NAME canac2setups
