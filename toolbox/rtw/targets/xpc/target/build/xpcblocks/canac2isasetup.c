/* $Revision: 1.5 $ $Date: 2002/03/25 04:02:15 $*/
...
#define 	S_FUNCTION_NAME 	canac2isasetup
...
static void mdlStart(SimStruct *S)
{
	...
	if (!CANAC2_FIRMWARE_LOADED[(int_T)mxGetPr(BOARD_ARG)[0]-1]) {
		...
		printf("        downloading CAN-AC2-ISA firmware\n");
		if ((ret = CANPC_reset_board()) != 0) {
   			printf("-->Error in CANPC_reset_board: ");
   			printResetErrorText(ret);
   			return;
		}
		printf("        downloading CAN-AC2-ISA firmware finished\n");
