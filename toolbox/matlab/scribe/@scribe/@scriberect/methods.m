...
% METHODS - methods for scriberect class
...
goodchildren(2:9) = double(h.Srect);
goodchildren(10) = double(h.FaceObject);
...
recttogg = uigettoolbar(fig,'Annotation.InsertRectangle');
set(recttogg,'state','off');
...
set(double(h.Rect),'Position',pos);
