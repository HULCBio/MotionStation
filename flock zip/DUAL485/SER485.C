/****************************************************************************
*****************************************************************************
    ser485.c        Serial RS485 Quatech Card (w/16550 UART Support)
...
*/
int configserialport(comport,baud)
short comport;
long baud;
{
    unsigned divisor;
    ...
    */
    ...
    /*
        Deassert DTR...Make the TRANCEIVER go to Receive
...
short comport;
{
    ...
    */
    while ((rxchar = get_serial_char(comport)) == NODATAAVAIL)
    {
        ...
        */
        if ((GETTICKS - starttime) > (long) (RXTIMEOUTINSECS * 1000) / systemconfig.tick_msec)
        {
