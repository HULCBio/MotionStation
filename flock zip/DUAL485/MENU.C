...
*****************************************************************************
    ...
    2/95           ssw - fixed filename bug
    3/9/95         ssw - change ESC in getfilename to return an ignore
...
/*
    ...
    Return Value:       char * filenamebuf if OK
                        NULL otherwise
                        int ignore  is 1 if ESC
                        zero otherwise

    Remarks:

*/
char * getfilename(filenamebuf,ignore)
char * filenamebuf;
int *ignore;
{
    char chr;
    ...
    */
    while (TRUE)
    {
        ...
        */
        ...
        if (chr == CR) 
        {
         if (tempfilenamebufptr == 0)
            return(filenamebuf);      /* return with default selected */
         else break;
        }
