...
1/9/96   vk..INPORT, OUTPORT definitions added to input/output a word
...
/* typedef INTTYPE void interrupt far */
#define INTTYPE void interrupt far

#define INPORT  inport              /* should compile to inline assembly */
#define OUTPORT outport             /* should compile to inline assembly */
