...
/* $Revision: 1.7.4.3 $ */
/*
 * File : sfun_runtime2.c
 * Abstract:
 *      Run-time parameter example. This S-function accepts N input
...
#define S_FUNCTION_NAME  sfun_runtime2
...
{
    /* Update Run-Time parameter */
    ssUpdateRunTimeParamData(S, 0, mxGetPr(GAIN_PARAM(S)));
}
