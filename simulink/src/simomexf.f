...
C     $Revision: 1.8 $
C
C     This is a FORTRAN representation of the SIMO system.
C     It works in conjunction with the the file simulink.for.
C     To compile this system, use the syntax:
C          mex simomex.f simulink.f
C
